...
function ScrollProgressBar() {
  ...
  return (
    <motion.div
      className="fixed top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-primary via-accent to-violet z-[60] origin-left"
      style={{ scaleX }}
    />
  );
}
...
/* ═══════════════════════════════════════════════════════════════════
   RESEARCH INTERESTS & INTERACTIVE DEMOS — 3D
   ═══════════════════════════════════════════════════════════════════ */
  ...
  return (
    <AnimatedSection id="research" className="py-24 px-4 bg-grid-dense">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Research Interests */}
        <h3 className="text-lg font-semibold mb-4 text-foreground flex items-center gap-2">
          <Lightbulb size={18} className="text-violet" /> Research Interests
        </h3>
